...
contract SWYP is ERC20, Ownable {
    ...
    constructor() ERC20("SWYP", "SWYP") {
        //MINT TOKENS
        _mint(msg.sender, 10000000000 * 10 ** decimals());

        //EXEMPT OWNER FROM LIMITS
    ...
    function _transfer(
        ...
        if(!isAntiWhaleExempt[sender] && !isAntiWhaleExempt[recipient]) {
            require(amount <= _maxTransactionLimit, "Cannot exceed Max Tx Limit");
        }
